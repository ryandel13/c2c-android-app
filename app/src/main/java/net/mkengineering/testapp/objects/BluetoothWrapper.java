...
/**
 * Created by MalteChristjan on 14.11.2017.
 */
...
public class BluetoothWrapper {
    ...
    public BluetoothWrapper(Activity activity) {
    ...
    private class ConnectThread extends Thread {
        public ConnectThread(BluetoothDevice device) {
            BluetoothWrapper.this.device = device;
            try {
                BluetoothWrapper.this.socket = device.createRfcommSocketToServiceRecord(MY_UUID);
            } catch (IOException e) {
                if (communicationCallback != null)
                    communicationCallback.onError(e.getMessage());
            }
